...
deploy() {
    ...
    ssh "$REMOTE_USER@$REMOTE_HOST" "tmux send-keys -t $TMUX_SESSION:$TMUX_WINDOW './petri-pilot serve -port $SERVICE_PORT tic-tac-toe zk-tic-tac-toe coffeeshop texas-holdem knapsack zk-ode' Enter"
