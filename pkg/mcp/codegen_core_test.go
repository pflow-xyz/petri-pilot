...
// petri_application and petri_bundle were folded into petri_build (see
// build_test.go: TestBuildFromSpec, TestBuildFromBundleDoc) — the composed
// pipeline they exercised (bundle.CompileApplication / bundle.Load →
// GenerateBundleFiles) is unchanged, only the MCP tool surface moved.
