...
func NewServer() *server.MCPServer {
	...
	s.AddTool(corrMatrixTool(), handleCorrMatrix)
	s.AddTool(phasePlotTool(), handlePhasePlot)
	s.AddTool(distributionTool(), handleDistribution)
	s.AddTool(paramHeatmapTool(), handleParamHeatmap)
	s.AddTool(riskTool(), handleRisk)
	s.AddTool(sankeyTool(), handleSankey)
