...
func TestInitialPlaces(t *testing.T) {
	...
	if initial[PlaceSubstrate] != 100 {
		t.Errorf("expected PlaceSubstrate initial = 100, got %d", initial[PlaceSubstrate])
	}
	if initial[PlaceEnzyme] != 10 {
		t.Errorf("expected PlaceEnzyme initial = 10, got %d", initial[PlaceEnzyme])
	}
}
...
func TestInitialState(t *testing.T) {
	...
	if places[PlaceSubstrate] != 100 {
		t.Errorf("expected PlaceSubstrate = 100, got %d", places[PlaceSubstrate])
	}
	if places[PlaceEnzyme] != 10 {
		t.Errorf("expected PlaceEnzyme = 10, got %d", places[PlaceEnzyme])
	}
}
