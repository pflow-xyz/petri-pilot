...
const ServiceName = "enzyme-kinetics"

func init() {
	serve.Register(ServiceName, NewService)
}

// Service implements serve.Service for the enzyme-kinetics workflow.
type Service struct {
...
// NewService creates a new enzyme-kinetics service instance.
