...
/**
 * Navigation component for texas-holdem application
...
function getDefaultNavigation() {
  ...
  return {
    brand: 'texas-holdem',
    items: [
      { label: 'texas-holdem', path: `${base}/texas-holdem`, icon: '' },
      { label: 'New', path: `${base}/texas-holdem/new`, icon: '+' },
...
export async function createNavigation() {
  ...
  const brandOnClick = isInDashView() ? '' : `onclick="handleNavClick(event, '${API_BASE}/texas-holdem')"`
...
window.handleLogout = async function() {
  ...
  await refreshNavigation()
  navigate(`${API_BASE}/texas-holdem`)
}
