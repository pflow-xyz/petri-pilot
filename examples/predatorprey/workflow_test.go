...
func TestInitialPlaces(t *testing.T) {
	...
	if initial[PlacePrey] != 100 {
		t.Errorf("expected PlacePrey initial = 100, got %d", initial[PlacePrey])
	}
	if initial[PlacePredator] != 20 {
		t.Errorf("expected PlacePredator initial = 20, got %d", initial[PlacePredator])
	}
}
...
func TestInitialState(t *testing.T) {
	...
	if places[PlacePrey] != 100 {
		t.Errorf("expected PlacePrey = 100, got %d", places[PlacePrey])
	}
	if places[PlacePredator] != 20 {
		t.Errorf("expected PlacePredator = 20, got %d", places[PlacePredator])
	}
}
