...
./ode-connect3 verify-parity [parityForceBias] [parityBlockBias] [tempoBias]
                       ...
                       # tier (parity.go) as the only new knobs; finding 13
...
./ode-connect3 fit-parity [games] [iters]
                       ...
                       # parityBlockBias/tempoBias only; finding 13
...
./ode-connect3 fit-parity-joint [games] [iters]
                       ...
                       # tempoBias, lambda) fit together; finding 13
```
...
13. **A declared future-support/gravity-parity place (ROADMAP.md Phase 1a,
