...
/**
 * Navigation component for tic-tac-toe application
...
export async function createNavigation() {
  ...
  const brandOnClick = isInDashView() ? '' : `onclick="handleNavClick(event, '${API_BASE}/tic-tac-toe')"`
