...
const defaultNavigation = {
  brand: 'task-manager',
  items: [
    { label: 'task-manager', path: `${API_BASE}/task-manager`, icon: '' },
    { label: 'New', path: `${API_BASE}/task-manager/new`, icon: '+' },
...
export async function createNavigation() {
  ...
  const html = `
    <nav class="navigation">
      <div class="nav-brand">
        <a href="${API_BASE}/task-manager" onclick="handleNavClick(event, '${API_BASE}/task-manager')">
          ${brand}
        </a>
      </div>
      <ul class="nav-menu">
...
window.handleLogout = async function() {
  ...
  await refreshNavigation()
  navigate(`${API_BASE}/task-manager`)
}
