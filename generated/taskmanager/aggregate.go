...
// State holds the aggregate state for task-manager.
type State struct {
...
// Aggregate wraps a StateMachine with the task-manager state.
...
func NewAggregate(id string) *Aggregate {
	...
	sm.RegisterHandler(EventTypeStart, func(state *State, event *eventsource.Event) error {
...
func applyStart(state *State, event *eventsource.Event) error {
