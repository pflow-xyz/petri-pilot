...
// CheckAccessStart verifies access for the start transition.
func CheckAccessStart(user *User, state map[string]any) error {
	if user == nil {
		return ErrUnauthorized
	}
