...
func TestInitialPlaces(t *testing.T) {
	...
	if initial[PlaceAvailable] != 1 {
		t.Errorf("expected PlaceAvailable initial = 1, got %d", initial[PlaceAvailable])
	}
}
...
func TestInitialState(t *testing.T) {
	...
	if places[PlaceAvailable] != 1 {
		t.Errorf("expected PlaceAvailable = 1, got %d", places[PlaceAvailable])
	}
}
