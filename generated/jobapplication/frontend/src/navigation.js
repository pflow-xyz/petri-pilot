...
const defaultNavigation = {
  ...
  items: [
    { label: 'job-application', path: `${API_BASE}/job-application`, icon: '' },
    { label: 'New', path: `${API_BASE}/job-application/new`, icon: '+' },
...
export async function createNavigation() {
  ...
  const html = `
    <nav class="navigation">
      <div class="nav-brand">
        <a href="${API_BASE}/job-application" onclick="handleNavClick(event, '${API_BASE}/job-application')">
          ${brand}
        </a>
      </div>
      <ul class="nav-menu">
