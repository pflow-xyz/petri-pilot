...
func NewAggregate(id string) *Aggregate {
	...
	sm.AddTransition(eventsource.Transition{
		ID:        TransitionSendSyn,
		EventType: EventTypeSendSyn,
		Inputs: map[string]int{
			PlaceClientClosed: 1,
			PlaceServerListen: 1,
		},
		Outputs: map[string]int{
			PlaceClientSynSent: 1,
		},
	})
	sm.AddTransition(eventsource.Transition{
		ID:        TransitionSendSynAck,
		EventType: EventTypeSendSynAck,
		Inputs: map[string]int{
			PlaceClientSynSent: 1,
		},
		Outputs: map[string]int{
			PlaceServerSynReceived: 1,
		},
	})
	sm.AddTransition(eventsource.Transition{
		ID:        TransitionSendAck,
		EventType: EventTypeSendAck,
		Inputs: map[string]int{
			PlaceServerSynReceived: 1,
		},
		Outputs: map[string]int{
			PlaceClientEstablished: 1,
			PlaceServerEstablished: 1,
		},
	})
	sm.AddTransition(eventsource.Transition{
		ID:        TransitionSendFin,
		EventType: EventTypeSendFin,
		Inputs: map[string]int{
			PlaceClientEstablished: 1,
		},
		Outputs: map[string]int{
	...
	sm.RegisterHandler(EventTypeSendSyn, func(state *State, event *eventsource.Event) error {
		return applySendSyn(state, event)
	})
	sm.RegisterHandler(EventTypeSendSynAck, func(state *State, event *eventsource.Event) error {
		return applySendSynAck(state, event)
	})
	sm.RegisterHandler(EventTypeSendAck, func(state *State, event *eventsource.Event) error {
		return applySendAck(state, event)
	})
	sm.RegisterHandler(EventTypeSendFin, func(state *State, event *eventsource.Event) error {
		return applySendFin(state, event)
	})
	sm.RegisterHandler(EventTypeSendFinAck, func(state *State, event *eventsource.Event) error {
		return applySendFinAck(state, event)
	})
...
func applySendSyn(state *State, event *eventsource.Event) error {
...
func applySendSynAck(state *State, event *eventsource.Event) error {
	// No data transformations for this transition
	_ = state
	_ = event
	return nil
...
func applySendAck(state *State, event *eventsource.Event) error {
	// No data transformations for this transition
	_ = state
	_ = event
	return nil
...
func applySendFin(state *State, event *eventsource.Event) error {
	// No data transformations for this transition
	_ = state
	_ = event
	return nil
...
func applySendFinAck(state *State, event *eventsource.Event) error {
	// No data transformations for this transition
	_ = state
	_ = event
	return nil
