...
var AllRolesFor = map[string][]string{
	...
	RoleAdmin: { "admin", "supervisor", "agent" },
}
...
// CheckAccessAssign verifies access for the assign transition.
func CheckAccessAssign(user *User, state map[string]any) error {
	if user == nil {
		return ErrUnauthorized
	}
	
	// Check role requirements (including dynamic role grants based on state)
	requiredRoles := []string{ "agent" }
...
// CheckAccessStartWork verifies access for the start_work transition.
func CheckAccessStartWork(user *User, state map[string]any) error {
	if user == nil {
		return ErrUnauthorized
	}
...
// CheckAccessEscalate verifies access for the escalate transition.
func CheckAccessEscalate(user *User, state map[string]any) error {
	if user == nil {
		return ErrUnauthorized
	}
...
// CheckAccessRequestInfo verifies access for the request_info transition.
func CheckAccessRequestInfo(user *User, state map[string]any) error {
	if user == nil {
		return ErrUnauthorized
	}
...
// CheckAccessCustomerReply verifies access for the customer_reply transition.
func CheckAccessCustomerReply(user *User, state map[string]any) error {
	if user == nil {
		return ErrUnauthorized
	}
...
// CheckAccessResolve verifies access for the resolve transition.
func CheckAccessResolve(user *User, state map[string]any) error {
	if user == nil {
		return ErrUnauthorized
	}
...
// CheckAccessReopen verifies access for the reopen transition.
func CheckAccessReopen(user *User, state map[string]any) error {
	if user == nil {
		return ErrUnauthorized
	}
