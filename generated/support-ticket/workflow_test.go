...
func TestInitialPlaces(t *testing.T) {
	...
	if initial[PlaceNew] != 1 {
		t.Errorf("expected PlaceNew initial = 1, got %d", initial[PlaceNew])
	}
}
...
func TestInitialState(t *testing.T) {
	agg := NewAggregate("")
	places := agg.Places()
	if places[PlaceNew] != 1 {
		t.Errorf("expected PlaceNew = 1, got %d", places[PlaceNew])
	}
}
