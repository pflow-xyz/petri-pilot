...
func TestInitialPlaces(t *testing.T) {
	...
	if initial[PlaceCart] != 1 {
		t.Errorf("expected PlaceCart initial = 1, got %d", initial[PlaceCart])
	}
}
...
func TestInitialState(t *testing.T) {
	agg := NewAggregate("")
	places := agg.Places()
	if places[PlaceCart] != 1 {
		t.Errorf("expected PlaceCart = 1, got %d", places[PlaceCart])
	}
}
