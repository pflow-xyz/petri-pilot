...
/**
 * Router configuration for test-access application
...
export const routes = [
  ...
  {
    path: '/test-access/new',
    component: 'Form',
    title: 'New test-access',
  },
  {
    path: '/test-access/:id',
    component: 'Detail',
    title: 'test-access Detail',
  },
  // Schema viewer
  {
    path: '/schema',
...
export function navigate(path, state = {}) {
  ...
  if (!match) {
    ...
    const fallbackPath = '/test-access'
...
export function initRouter() {
  ...
  if (match) {
    ...
    currentRoute = routes.find(r => r.path === '/test-access') || routes[0]
    currentParams = {}
  }
}
