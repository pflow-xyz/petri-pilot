...
/**
 * Navigation component for test-access application
...
function getDefaultNavigation() {
  ...
  return {
    brand: 'test-access',
    items: [
      { label: 'test-access', path: `${base}/test-access`, icon: '' },
      { label: 'New', path: `${base}/test-access/new`, icon: '+' },
...
export async function createNavigation() {
  ...
  const brandOnClick = isInDashView() ? '' : `onclick="handleNavClick(event, '${API_BASE}/test-access')"`
