-- Migration: 001_init_testaccess
-- Generated by petri-pilot. DO NOT EDIT.
--
-- Event store schema for test-access workflow
...
-- Projection: test-access aggregate state
-- Denormalized view for fast reads
CREATE TABLE IF NOT EXISTS "testaccess_state" (
    id TEXT PRIMARY KEY,
...
CREATE INDEX IF NOT EXISTS "idx_testaccess_state_updated" ON "testaccess_state"(updated_at);

-- Place tokens tracking (Petri net state)
CREATE TABLE IF NOT EXISTS "testaccess_places" (
