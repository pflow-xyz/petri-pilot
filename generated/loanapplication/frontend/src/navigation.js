...
/**
 * Navigation component for loan-application application
...
function getDefaultNavigation() {
  ...
  return {
    ...
    items: [
      { label: 'loan-application', path: `${base}/loan-application`, icon: '' },
      { label: 'New', path: `${base}/loan-application/new`, icon: '+' },
...
function getCustomFrontendUrl() {
  ...
  return API_BASE + '/loan-application'
}
...
export async function createNavigation() {
  ...
  const brandOnClick = isInDashView() ? '' : `onclick="handleNavClick(event, '${API_BASE}/loan-application')"`
