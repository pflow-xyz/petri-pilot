...
func TestWorkflowConstants(t *testing.T) {
	...
	if len(transitions) != 12 {
		t.Errorf("expected 12 transitions, got %d", len(transitions))
	}
}
...
func TestInitialPlaces(t *testing.T) {
	...
	if initial[PlaceSubmitted] != 1 {
		t.Errorf("expected PlaceSubmitted initial = 1, got %d", initial[PlaceSubmitted])
	}
}
...
func TestInitialState(t *testing.T) {
	...
	if places[PlaceSubmitted] != 1 {
		t.Errorf("expected PlaceSubmitted = 1, got %d", places[PlaceSubmitted])
	}
}
