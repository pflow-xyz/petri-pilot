...
const defaultNavigation = {
  ...
  items: [
    { label: 'ecommerce-checkout', path: `${API_BASE}/ecommerce-checkout`, icon: '' },
    { label: 'New', path: `${API_BASE}/ecommerce-checkout/new`, icon: '+' },
...
export async function createNavigation() {
  ...
  const html = `
    <nav class="navigation">
      <div class="nav-brand">
        <a href="${API_BASE}/ecommerce-checkout" onclick="handleNavClick(event, '${API_BASE}/ecommerce-checkout')">
          ${brand}
        </a>
      </div>
      <ul class="nav-menu">
