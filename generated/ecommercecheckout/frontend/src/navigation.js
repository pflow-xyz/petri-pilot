...
/**
 * Navigation component for ecommerce-checkout application
...
function getDefaultNavigation() {
  ...
  return {
    ...
    items: [
      { label: 'ecommerce-checkout', path: `${base}/ecommerce-checkout`, icon: '' },
      { label: 'New', path: `${base}/ecommerce-checkout/new`, icon: '+' },
...
function getCustomFrontendUrl() {
  ...
  return API_BASE + '/ecommerce-checkout'
}
...
export async function createNavigation() {
  ...
  const brandOnClick = isInDashView() ? '' : `onclick="handleNavClick(event, '${API_BASE}/ecommerce-checkout')"`
...
window.handleLogout = async function() {
  ...
  await refreshNavigation()
  navigate(`${API_BASE}/ecommerce-checkout`)
}
