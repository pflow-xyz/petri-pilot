...
/**
 * Admin Dashboard for ecommerce-checkout application
  ...
  return `
    <div class="admin-dashboard">
      <div class="admin-header">
        ...
        <p class="admin-subtitle">ecommerce-checkout System Overview</p>
      </div>
...
export function renderAdminInstances() {
  ...
  return `
    <div class="admin-instances">
      <div class="admin-header">
        <h1>Instances</h1>
        <a href="/admin" onclick="handleAdminNav(event, '/admin')" class="btn btn-link">← Back to Dashboard</a>
      </div>
  ...
  return `
    <div class="admin-instance-detail">
      <div class="admin-header">
        ...
        <a href="/admin/instances" onclick="handleAdminNav(event, '/admin/instances')" class="btn btn-link">← Back to Instances</a>
      </div>
