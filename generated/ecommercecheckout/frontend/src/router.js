...
/**
 * Router configuration for ecommerce-checkout application
...
export const routes = [
  ...
  {
    path: '/ecommerce-checkout/new',
    component: 'Form',
    title: 'New ecommerce-checkout',
  },
  {
    path: '/ecommerce-checkout/:id',
    component: 'Detail',
    title: 'ecommerce-checkout Detail',
  },
  // Schema viewer
  {
    path: '/schema',
...
export function navigate(path, state = {}) {
  ...
  if (!match) {
    ...
    const fallbackPath = '/ecommerce-checkout'
  ...
  if (match.route.roles && match.route.roles.length > 0) {
    ...
    if (!user || !hasAnyRole(user, match.route.roles)) {
      ...
      navigate(`${getFrontendBase()}/ecommerce-checkout`)
      return
    }
  }
...
export function initRouter() {
  ...
  if (match) {
    ...
    currentRoute = routes.find(r => r.path === '/ecommerce-checkout') || routes[0]
    currentParams = {}
  }
}
