...
// =============================================================================
// EXAMPLE: Custom "Export JSON" action for tic-tac-toe
// =============================================================================
...
adminExtensions.customActions.push({
  ...
  onClick: (instance) => {
    ...
    a.href = url
    a.download = `game-${instance.id}.json`
    a.click()
    URL.revokeObjectURL(url)
  }
})

// Example: Log archive/delete events
registerHook('onInstanceArchived', (id) => {
  console.log(`Game ${id} was archived`)
})

registerHook('onInstanceDeleted', (id) => {
  console.log(`Game ${id} was permanently deleted`)
})
