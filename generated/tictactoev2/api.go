...
func StaticFileHandler() http.HandlerFunc {
	...
	candidates := []string{
		...
		"generated/tictactoev2/frontend",         // Generated frontend from repo root
		filepath.Join("generated", "tictactoev2", "frontend"), // Platform-safe
	}
	...
	if exe, err := os.Executable(); err == nil {
		...
		candidates = append(candidates,
			...
			filepath.Join(exeDir, "generated", "tictactoev2", "frontend"),
		)
	}
