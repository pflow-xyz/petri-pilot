...
const ServiceName = "producer-consumer"

func init() {
	serve.Register(ServiceName, NewService)
}

// Service implements serve.Service for the producer-consumer workflow.
type Service struct {
...
// NewService creates a new producer-consumer service instance.
