...
func TestWorkflowConstants(t *testing.T) {
	...
	places := AllPlaces()
	if len(places) != 7 {
		t.Errorf("expected 7 places, got %d", len(places))
	}
...
func TestInitialPlaces(t *testing.T) {
	...
	if initial[PlaceProducerIdle] != 1 {
		t.Errorf("expected PlaceProducerIdle initial = 1, got %d", initial[PlaceProducerIdle])
	}
	if initial[PlaceBufferSpace] != 5 {
		t.Errorf("expected PlaceBufferSpace initial = 5, got %d", initial[PlaceBufferSpace])
	}
	if initial[PlaceConsumerIdle] != 1 {
		t.Errorf("expected PlaceConsumerIdle initial = 1, got %d", initial[PlaceConsumerIdle])
	}
}
...
func TestInitialState(t *testing.T) {
	...
	if places[PlaceProducerIdle] != 1 {
		t.Errorf("expected PlaceProducerIdle = 1, got %d", places[PlaceProducerIdle])
	}
	if places[PlaceBufferSpace] != 5 {
		t.Errorf("expected PlaceBufferSpace = 5, got %d", places[PlaceBufferSpace])
	}
	if places[PlaceConsumerIdle] != 1 {
		t.Errorf("expected PlaceConsumerIdle = 1, got %d", places[PlaceConsumerIdle])
	}
}
