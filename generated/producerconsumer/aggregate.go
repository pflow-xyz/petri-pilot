...
func NewAggregate(id string) *Aggregate {
	...
	sm.AddTransition(eventsource.Transition{
		ID:        TransitionFinishProduce,
		EventType: EventTypeFinishProduce,
		Inputs: map[string]int{
			PlaceProducing: 1,
		},
		Outputs: map[string]int{
	...
	sm.AddTransition(eventsource.Transition{
		ID:        TransitionFinishConsume,
		EventType: EventTypeFinishConsume,
		Inputs: map[string]int{
			PlaceConsuming: 1,
		},
		Outputs: map[string]int{
	...
	sm.RegisterHandler(EventTypeStartProduce, func(state *State, event *eventsource.Event) error {
		return applyStartProduce(state, event)
	})
	sm.RegisterHandler(EventTypeFinishProduce, func(state *State, event *eventsource.Event) error {
		return applyFinishProduce(state, event)
	})
	sm.RegisterHandler(EventTypeStartConsume, func(state *State, event *eventsource.Event) error {
		return applyStartConsume(state, event)
	})
	sm.RegisterHandler(EventTypeFinishConsume, func(state *State, event *eventsource.Event) error {
		return applyFinishConsume(state, event)
	})
...
func applyStartProduce(state *State, event *eventsource.Event) error {
...
func applyFinishProduce(state *State, event *eventsource.Event) error {
	// No data transformations for this transition
	_ = state
	_ = event
	return nil
...
func applyStartConsume(state *State, event *eventsource.Event) error {
	// No data transformations for this transition
	_ = state
	_ = event
	return nil
...
func applyFinishConsume(state *State, event *eventsource.Event) error {
	// No data transformations for this transition
	_ = state
	_ = event
	return nil
