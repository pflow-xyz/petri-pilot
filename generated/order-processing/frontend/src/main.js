...
const api = {
  ...
  async getInstance(id) {
    const response = await fetch(`${API_BASE}/api/order-processing/${id}`, { headers: getHeaders() })
    return handleResponse(response)
  },

  async createInstance(data = {}) {
    const response = await fetch(`${API_BASE}/api/order-processing`, {
      method: 'POST',
      headers: getHeaders(),
  ...
  async executeTransition(transitionId, aggregateId, data = {}) {
    const response = await fetch(`${API_BASE}/api/order-processing/transitions/${transitionId}`, {
      method: 'POST',
      headers: getHeaders(),
