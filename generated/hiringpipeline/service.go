...
const ServiceName = "hiring-pipeline"

func init() {
	serve.Register(ServiceName, NewService)
}

// Service implements serve.Service for the hiring-pipeline workflow.
type Service struct {
...
// NewService creates a new hiring-pipeline service instance.
