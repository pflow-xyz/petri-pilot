...
/**
 * Router configuration for texas-holdem application
...
export const routes = [
  ...
  {
    path: '/texas-holdem/new',
    component: 'Form',
    title: 'New texas-holdem',
  },
  {
    path: '/texas-holdem/:id',
    component: 'Detail',
    title: 'texas-holdem Detail',
  },
  // Schema viewer
  {
    path: '/schema',
...
export function navigate(path, state = {}) {
  ...
  if (!match) {
    ...
    const fallbackPath = '/texas-holdem'
  ...
  if (match.route.roles && match.route.roles.length > 0) {
    ...
    if (!user || !hasAnyRole(user, match.route.roles)) {
      ...
      navigate(`${getFrontendBase()}/texas-holdem`)
      return
    }
  }
...
export function initRouter() {
  ...
  if (match) {
    ...
    currentRoute = routes.find(r => r.path === '/texas-holdem') || routes[0]
    currentParams = {}
  }
}
