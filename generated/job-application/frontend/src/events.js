...
const eventsAPI = {
  ...
  async getEvents(aggregateId, fromVersion = 0) {
    const response = await fetch(`${API_BASE}/api/job-application/${aggregateId}/events?from=${fromVersion}`, {
      headers: getHeaders(),
    })
  ...
  async getStateAtVersion(aggregateId, version) {
    const response = await fetch(`${API_BASE}/api/job-application/${aggregateId}/at/${version}`, {
      headers: getHeaders(),
    })
    return handleResponse(response)
  },
  ...
  async createSnapshot(aggregateId) {
    const response = await fetch(`${API_BASE}/api/job-application/${aggregateId}/snapshot`, {
      method: 'POST',
      headers: getHeaders(),
    })
    return handleResponse(response)
  ...
  async replayFromSnapshot(aggregateId) {
    const response = await fetch(`${API_BASE}/api/job-application/${aggregateId}/replay`, {
      method: 'POST',
      headers: getHeaders(),
    })
    return handleResponse(response)
