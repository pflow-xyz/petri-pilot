...
func TestWorkflowConstants(t *testing.T) {
	...
	if len(transitions) != 13 {
		t.Errorf("expected 13 transitions, got %d", len(transitions))
	}
}
...
func TestInitialPlaces(t *testing.T) {
	...
	if initial[PlaceRequested] != 1 {
		t.Errorf("expected PlaceRequested initial = 1, got %d", initial[PlaceRequested])
	}
}
...
func TestInitialState(t *testing.T) {
	...
	if places[PlaceRequested] != 1 {
		t.Errorf("expected PlaceRequested = 1, got %d", places[PlaceRequested])
	}
}
