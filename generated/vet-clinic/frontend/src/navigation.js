...
/**
 * Navigation component for vet-clinic application
...
const availableRoles = [
  { id: 'office_manager', description: "" },
  { id: 'dvm', description: "" },
  { id: 'rvt', description: "" },
  { id: 'vet_assistant', description: "" },
  { id: 'front_desk', description: "" },
]
...
const defaultNavigation = {
  brand: 'vet-clinic',
  items: [
    { label: 'vet-clinic', path: '/vet-clinic', icon: '' },
    { label: 'New', path: '/vet-clinic/new', icon: '+' },
...
export async function createNavigation() {
  ...
  const html = `
    <nav class="navigation">
      <div class="nav-brand">
        <a href="/vet-clinic" onclick="handleNavClick(event, '/vet-clinic')">
          ${brand}
        </a>
      </div>
      <ul class="nav-menu">
