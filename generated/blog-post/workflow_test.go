...
func TestInitialPlaces(t *testing.T) {
	...
	if initial[PlaceDraft] != 1 {
		t.Errorf("expected PlaceDraft initial = 1, got %d", initial[PlaceDraft])
	}
}
...
func TestInitialState(t *testing.T) {
	agg := NewAggregate("")
	places := agg.Places()
	if places[PlaceDraft] != 1 {
		t.Errorf("expected PlaceDraft = 1, got %d", places[PlaceDraft])
	}
}
