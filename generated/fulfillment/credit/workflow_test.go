...
func TestInitialPlaces(t *testing.T) {
	...
	if initial[PlaceUnverified] != 1 {
		t.Errorf("expected PlaceUnverified initial = 1, got %d", initial[PlaceUnverified])
	}
}
...
func TestInitialState(t *testing.T) {
	...
	if places[PlaceUnverified] != 1 {
		t.Errorf("expected PlaceUnverified = 1, got %d", places[PlaceUnverified])
	}
}
