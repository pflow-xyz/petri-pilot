...
const api = {
  ...
  async getInstance(id) {
    const response = await fetch(`${API_BASE}/api/task-manager/${id}`, { headers: getHeaders() })
    return handleResponse(response)
  },

  async createInstance(data = {}) {
    const response = await fetch(`${API_BASE}/api/task-manager`, {
      method: 'POST',
      headers: getHeaders(),
  ...
  async executeTransition(transitionId, aggregateId, data = {}) {
    const response = await fetch(`${API_BASE}/api/task-manager/transitions/${transitionId}`, {
      method: 'POST',
      headers: getHeaders(),
