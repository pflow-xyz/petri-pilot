...
const ServiceName = "dining-philosophers"

func init() {
	serve.Register(ServiceName, NewService)
}

// Service implements serve.Service for the dining-philosophers workflow.
type Service struct {
...
// NewService creates a new dining-philosophers service instance.
