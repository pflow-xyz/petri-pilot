...
func TestInitialPlaces(t *testing.T) {
	...
	if initial[PlaceAvailable] != 2 {
		t.Errorf("expected PlaceAvailable initial = 2, got %d", initial[PlaceAvailable])
	}
}
...
func TestInitialState(t *testing.T) {
	...
	if places[PlaceAvailable] != 2 {
		t.Errorf("expected PlaceAvailable = 2, got %d", places[PlaceAvailable])
	}
}
