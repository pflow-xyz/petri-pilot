...
func NewAggregate(id string) *Aggregate {
	...
	sm.AddTransition(eventsource.Transition{
		ID:        TransitionStartReviews,
		EventType: EventTypeStartReviews,
	...
	sm.AddTransition(eventsource.Transition{
		ID:        TransitionApproveCredit,
		EventType: EventTypeApproveCredit,
		Inputs: map[string]int{
			PlaceCreditReview: 1,
		},
		Outputs: map[string]int{
	...
	sm.AddTransition(eventsource.Transition{
		ID:        TransitionRejectCredit,
		EventType: EventTypeRejectCredit,
		Inputs: map[string]int{
			PlaceCreditReview: 1,
		},
		Outputs: map[string]int{
	...
	sm.AddTransition(eventsource.Transition{
		ID:        TransitionApproveEmployment,
		EventType: EventTypeApproveEmployment,
		Inputs: map[string]int{
			PlaceEmploymentReview: 1,
		},
		Outputs: map[string]int{
	...
	sm.AddTransition(eventsource.Transition{
		ID:        TransitionRejectEmployment,
		EventType: EventTypeRejectEmployment,
		Inputs: map[string]int{
			PlaceEmploymentReview: 1,
		},
		Outputs: map[string]int{
			PlaceEmploymentFailed: 1,
		},
	})
	sm.AddTransition(eventsource.Transition{
		...
		Outputs: map[string]int{
			PlaceReadyForDecision: 1,
		},
	})
	sm.AddTransition(eventsource.Transition{
		ID:        TransitionBeginUnderwriting,
		EventType: EventTypeBeginUnderwriting,
		Inputs: map[string]int{
			PlaceReadyForDecision: 1,
		},
		Outputs: map[string]int{
	...
	sm.AddTransition(eventsource.Transition{
		ID:        TransitionApproveLoan,
		EventType: EventTypeApproveLoan,
		Inputs: map[string]int{
			PlaceUnderReview: 1,
		},
		Outputs: map[string]int{
	...
	sm.AddTransition(eventsource.Transition{
		ID:        TransitionRejectLoan,
		EventType: EventTypeRejectLoan,
		Inputs: map[string]int{
			PlaceUnderReview: 1,
		},
		Outputs: map[string]int{
	...
	sm.AddTransition(eventsource.Transition{
		ID:        TransitionRejectOnCredit,
		EventType: EventTypeRejectOnCredit,
		Inputs: map[string]int{
			PlaceCreditFailed: 1,
		},
		Outputs: map[string]int{
	...
	sm.AddTransition(eventsource.Transition{
		ID:        TransitionRejectOnEmployment,
		EventType: EventTypeRejectOnEmployment,
		Inputs: map[string]int{
			PlaceEmploymentFailed: 1,
		},
		Outputs: map[string]int{
	...
	sm.RegisterHandler(EventTypeStartReviews, func(state *State, event *eventsource.Event) error {
		return applyStartReviews(state, event)
	})
	sm.RegisterHandler(EventTypeApproveCredit, func(state *State, event *eventsource.Event) error {
		return applyApproveCredit(state, event)
	})
	sm.RegisterHandler(EventTypeRejectCredit, func(state *State, event *eventsource.Event) error {
		return applyRejectCredit(state, event)
	})
	sm.RegisterHandler(EventTypeApproveEmployment, func(state *State, event *eventsource.Event) error {
		return applyApproveEmployment(state, event)
	})
	sm.RegisterHandler(EventTypeRejectEmployment, func(state *State, event *eventsource.Event) error {
		return applyRejectEmployment(state, event)
	})
	sm.RegisterHandler(EventTypeMergeReviews, func(state *State, event *eventsource.Event) error {
		return applyMergeReviews(state, event)
	})
	sm.RegisterHandler(EventTypeBeginUnderwriting, func(state *State, event *eventsource.Event) error {
		return applyBeginUnderwriting(state, event)
	})
	sm.RegisterHandler(EventTypeApproveLoan, func(state *State, event *eventsource.Event) error {
		return applyApproveLoan(state, event)
	})
	sm.RegisterHandler(EventTypeRejectLoan, func(state *State, event *eventsource.Event) error {
		return applyRejectLoan(state, event)
	})
	sm.RegisterHandler(EventTypeRejectOnCredit, func(state *State, event *eventsource.Event) error {
		return applyRejectOnCredit(state, event)
	})
	sm.RegisterHandler(EventTypeRejectOnEmployment, func(state *State, event *eventsource.Event) error {
		return applyRejectOnEmployment(state, event)
	})
...
func applyStartReviews(state *State, event *eventsource.Event) error {
...
func applyApproveCredit(state *State, event *eventsource.Event) error {
	// No data transformations for this transition
	_ = state
	_ = event
	return nil
...
func applyRejectCredit(state *State, event *eventsource.Event) error {
	// No data transformations for this transition
	_ = state
	_ = event
	return nil
...
func applyApproveEmployment(state *State, event *eventsource.Event) error {
	// No data transformations for this transition
	_ = state
	_ = event
	return nil
...
func applyRejectEmployment(state *State, event *eventsource.Event) error {
	// No data transformations for this transition
	_ = state
	_ = event
	return nil
...
func applyMergeReviews(state *State, event *eventsource.Event) error {
	// No data transformations for this transition
	_ = state
	_ = event
	return nil
...
func applyBeginUnderwriting(state *State, event *eventsource.Event) error {
	// No data transformations for this transition
	_ = state
	_ = event
	return nil
...
func applyApproveLoan(state *State, event *eventsource.Event) error {
	// No data transformations for this transition
	_ = state
	_ = event
	return nil
...
func applyRejectLoan(state *State, event *eventsource.Event) error {
	// No data transformations for this transition
	_ = state
	_ = event
	return nil
...
func applyRejectOnCredit(state *State, event *eventsource.Event) error {
	// No data transformations for this transition
	_ = state
	_ = event
	return nil
...
func applyRejectOnEmployment(state *State, event *eventsource.Event) error {
	// No data transformations for this transition
	_ = state
	_ = event
	return nil
