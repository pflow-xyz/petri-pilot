...
function getDefaultNavigation() {
  ...
  return {
    ...
    items: [
      { label: 'support-ticket', path: `${base}/support-ticket`, icon: '' },
      { label: 'New', path: `${base}/support-ticket/new`, icon: '+' },
...
function getCustomFrontendUrl() {
  ...
  return API_BASE + '/support-ticket'
}
...
export async function createNavigation() {
  ...
  const brandOnClick = isInDashView() ? '' : `onclick="handleNavClick(event, '${API_BASE}/support-ticket')"`
...
window.handleLogout = async function() {
  ...
  await refreshNavigation()
  navigate(`${API_BASE}/support-ticket`)
}
