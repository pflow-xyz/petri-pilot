...
func TestInitialPlaces(t *testing.T) {
	...
	if initial[PlaceRed] != 1 {
		t.Errorf("expected PlaceRed initial = 1, got %d", initial[PlaceRed])
	}
}
...
func TestInitialState(t *testing.T) {
	...
	if places[PlaceRed] != 1 {
		t.Errorf("expected PlaceRed = 1, got %d", places[PlaceRed])
	}
}
