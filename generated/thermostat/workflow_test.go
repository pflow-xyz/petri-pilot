...
func TestWorkflowConstants(t *testing.T) {
	...
	places := AllPlaces()
	if len(places) != 3 {
		t.Errorf("expected 3 places, got %d", len(places))
	}
...
func TestInitialPlaces(t *testing.T) {
	...
	if initial[PlaceTemperature] != 15 {
		t.Errorf("expected PlaceTemperature initial = 15, got %d", initial[PlaceTemperature])
	}
	if initial[PlaceHeaterOff] != 1 {
		t.Errorf("expected PlaceHeaterOff initial = 1, got %d", initial[PlaceHeaterOff])
	}
}
...
func TestInitialState(t *testing.T) {
	...
	if places[PlaceTemperature] != 15 {
		t.Errorf("expected PlaceTemperature = 15, got %d", places[PlaceTemperature])
	}
	if places[PlaceHeaterOff] != 1 {
		t.Errorf("expected PlaceHeaterOff = 1, got %d", places[PlaceHeaterOff])
	}
}
