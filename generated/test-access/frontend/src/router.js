...
/**
 * Router configuration for access-test application
...
export const routes = [
  {
    path: '/access-test',
    component: 'AccessTestList',
    title: 'Access-Test List',
  },
  {
    path: '/access-test/:id',
    component: 'AccessTestDetail',
    title: 'Access-Test Detail',
  },
  {
    path: '/access-test/new',
    component: 'AccessTestForm',
    title: 'New Access-Test',
  },
  // Admin routes
  {
    path: '/admin',
