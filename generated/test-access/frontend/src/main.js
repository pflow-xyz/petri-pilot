...
const api = {
  ...
  async getInstance(id) {
    const response = await fetch(`${API_BASE}/api/access-test/${id}`, { headers: getHeaders() })
    return handleResponse(response)
  },

  async createInstance(data = {}) {
    const response = await fetch(`${API_BASE}/api/access-test`, {
      method: 'POST',
      headers: getHeaders(),
  ...
  async executeTransition(transitionId, aggregateId, data = {}) {
    const response = await fetch(`${API_BASE}/api/access-test/transitions/${transitionId}`, {
      method: 'POST',
      headers: getHeaders(),
