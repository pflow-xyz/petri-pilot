var ae=Object.defineProperty;var oe=(e,t,n)=>t in e?ae(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n;var M=(e,t,n)=>oe(e,typeof t!="symbol"?t+"":t,n);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))s(a);new MutationObserver(a=>{for(const o of a)if(o.type==="childList")for(const d of o.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&s(d)}).observe(document,{childList:!0,subtree:!0});function n(a){const o={};return a.integrity&&(o.integrity=a.integrity),a.referrerPolicy&&(o.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?o.credentials="include":a.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function s(a){if(a.ep)return;a.ep=!0;const o=n(a);fetch(a.href,o)}})();const Q="orderprocessing";class $ extends HTMLElement{static get observedAttributes(){return[]}constructor(){super(),this.attachShadow({mode:"open"}),this._state={},this._props={},this._connected=!1}connectedCallback(){var t;this._connected=!0,this._initAttributes(),this.render(),(t=this.onConnect)==null||t.call(this)}disconnectedCallback(){var t;this._connected=!1,(t=this.onDisconnect)==null||t.call(this)}attributeChangedCallback(t,n,s){var a;n!==s&&(this._props[t]=this._parseAttribute(t,s),(a=this.onAttributeChange)==null||a.call(this,t,n,s),this._connected&&this.render())}_initAttributes(){const t=this.constructor.attributes||{};for(const[n,s]of Object.entries(t)){const a=this.getAttribute(n);this._props[n]=a!==null?this._parseAttribute(n,a):s.default}}_parseAttribute(t,n){const s=(this.constructor.attributes||{})[t];if(!s)return n;switch(s.type){case"number":return parseFloat(n)||s.default||0;case"boolean":return n!==null&&n!=="false";case"json":try{return JSON.parse(n)}catch{return s.default||null}default:return n}}prop(t){var n,s;return this._props[t]??((s=(n=this.constructor.attributes)==null?void 0:n[t])==null?void 0:s.default)}setProp(t,n){this._props[t]=n;const s=(this.constructor.attributes||{})[t];(s==null?void 0:s.type)==="json"?this.setAttribute(t,JSON.stringify(n)):(s==null?void 0:s.type)==="boolean"?n?this.setAttribute(t,""):this.removeAttribute(t):this.setAttribute(t,String(n))}set state(t){this._state=t,this._connected&&this.render()}get state(){return this._state}styles(){return""}template(){return""}render(){var t;this.shadowRoot.innerHTML=`
    ...
    `}}class de extends ${static get observedAttributes(){return["compact"]}styles(){return`
      .state-grid {
        display: grid;
        gap: 0.75rem;
      }
    ...
    `}template(){const t=this._state||{};return`
      <div class="state-grid">
        ...
        ${Object.entries(t).filter(([s])=>!s.startsWith("_")).map(([s,a])=>{const o=s.replace(/_/g," "),d=a>0?"positive":a===0?"zero":"";return`
          <div class="state-item">
            <span class="state-label">${o}</span>
            <span class="state-value ${d}">${a}</span>
          </div>
        `}).join("")}
        <slot name="after"></slot>
        <slot></slot>
      </div>
    `}}class ce extends ${static get observedAttributes(){return["action","disabled","variant","label"]}styles(){return`
      button {
        width: 100%;
    ...
    `}template(){const t=this.prop("label"),n=this.prop("value"),s=this.prop("capacity"),a=this.prop("unit"),o=this.prop("warning-threshold"),d=this.prop("color"),r=s>0?n/s*100:0,l=d?"":r<o*100?"danger":r<50?"warning":"good",c=d?`background: ${d}`:"";return`
      <div class="gauge">
        ...
        <div class="gauge-bar">
          <div class="gauge-fill ${l}" style="width: ${r}%; ${c}"></div>
        </div>
        <slot></slot>
      </div>
    `}}M(Z,"attributes",{label:{type:"string",default:"Resource"},value:{type:"number",default:0},capacity:{type:"number",default:100},unit:{type:"string",default:""},"warning-threshold":{type:"number",default:.3},color:{type:"string",default:""}});class ue extends ${styles(){return`
      .flow-container {
        display: flex;
        gap: 1rem;
        overflow-x: auto;
    ...
    `}}function pe(){x("dashboard",re),x("state-display",de),x("action-button",ce),x("instance-card",le),x("inventory-gauge",Z),x("order-flow",ue)}window.__PETRI_SKIP_AUTO_REGISTER__||pe();window.PetriElement=$;window.registerComponent=x;window.getComponent=ie;const z=[{path:"/",component:"List",title:"order-processing"},{path:"/order-processing",component:"List",title:"order-processing"},{path:"/order-processing/new",component:"Form",title:"New order-processing"},{path:"/order-processing/:id",component:"Detail",title:"order-processing Detail"},{path:"/schema",component:"Schema",title:"Schema Viewer"},{path:"/admin",component:"AdminDashboard",title:"Admin Dashboard"},{path:"/admin/instances",component:"AdminInstances",title:"Instances"},{path:"/admin/instances/:id",component:"AdminInstance",title:"Instance Detail"}];let k=null,E={};function N(e){e=e||"/",e!=="/"&&e.endsWith("/")&&(e=e.slice(0,-1));for(const t of z){const n={};let s=t.path.replace(/[.*+?^${}()|[\]\\]/g,"\\$&");s=s.replace(/:[^/]+/g,"([^/]+)");const a=new RegExp(`^${s}$`),o=e.match(a);if(o)return(t.path.match(/:[^/]+/g)||[]).map(r=>r.slice(1)).forEach((r,l)=>{n[r]=decodeURIComponent(o[l+1])}),{route:t,params:n}}return null}function h(e,t={}){e.startsWith("/")||(e="/"+e);const n=N(e);if(!n){console.warn(`No route found for path: ${e}, falling back to list`),e="/order-processing";const s=N(e);s&&(k=s.route,E=s.params,window.history.pushState(t,"",e),H());return}if(n.route.roles&&n.route.roles.length>0){const s=me();if(!s||!he(s,n.route.roles)){console.warn("Access denied:",e),h("/order-processing");return}}k=n.route,E=n.params,window.history.pushState(t,"",e),H()}window.addEventListener("popstate",()=>{const e=window.location.pathname,t=N(e);t?(k=t.route,E=t.params,H()):h("/order-processing")});function me(){const e=localStorage.getItem("auth");if(e)try{return JSON.parse(e).user}catch{return null}return null}function he(e,t){return!e||!e.roles?!1:t.some(n=>e.roles.includes(n))}function H(){window.dispatchEvent(new CustomEvent("route-change",{detail:{route:k,params:E}}))}function ge(){return E}function C(){return k}function fe(){const e=window.location.pathname,t=N(e);t?(k=t.route,E=t.params):(k=z.find(n=>n.path==="/order-processing")||z[0],E={})}const K=[{id:"customer",description:"End user placing orders"},{id:"fulfillment",description:"Warehouse staff who validate and ship orders"},{id:"system",description:"Automated payment processing"},{id:"admin",description:"Full access to all operations"}],I={brand:"order-processing",items:[{label:"order-processing",path:"/order-processing",icon:""},{label:"New",path:"/order-processing/new",icon:"+"},{label:"Schema",path:"/schema",icon:"⚙"},{label:"Admin",path:"/admin",icon:""}]};let m=null,F=!1;async function ee(){if(!F){F=!0;try{const e={},t=ne();t&&(e.Authorization=`Bearer ${t}`);const n=await fetch("/api/navigation",{headers:e});n.ok?m=await n.json():m=I}catch{m=I}finally{F=!1}}}async function te(){m||await ee();const e=window.location.pathname,t=ve(),n=(m==null?void 0:m.items)||I.items;return`
    <nav class="navigation">
      <div class="nav-brand">
        <a href="/order-processing" onclick="handleNavClick(event, '/order-processing')">
          ${(m==null?void 0:m.brand)||I.brand}
        </a>
      </div>
      <ul class="nav-menu">
        ${n.map(o=>`
  ...
  `}window.showLoginModal=function(){const e=document.getElementById("login-modal");e&&(e.style.display="flex")};window.hideLoginModal=function(){const e=document.getElementById("login-modal");e&&(e.style.display="none")};window.handleRoleLogin=async function(e){try{const t=await fetch("/api/debug/login",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({login:"pilot-user",roles:e})});if(!t.ok)throw new Error("Login failed");const n=await t.json();localStorage.setItem("auth",JSON.stringify(n)),hideLoginModal(),m=null,window.dispatchEvent(new CustomEvent("auth-change")),await P()}catch(t){console.error("Login error:",t),alert("Login failed. Please try again.")}};window.handleNavClick=function(e,t){e.preventDefault(),h(t)};window.handleLogout=async function(){try{const e=ne();e&&await fetch("/auth/logout",{method:"POST",headers:{Authorization:`Bearer ${e}`}})}catch(e){console.error("Logout error:",e)}localStorage.removeItem("auth"),m=null,window.dispatchEvent(new CustomEvent("auth-change")),await P(),h("/order-processing")};function ve(){const e=localStorage.getItem("auth");if(e)try{return JSON.parse(e).user}catch{return null}return null}function ne(){const e=localStorage.getItem("auth");if(e)try{return JSON.parse(e).token}catch{return null}return null}async function P(){m=null,await ee();const e=document.getElementById("nav");e&&(e.innerHTML=await te())}window.addEventListener("auth-change",async()=>{await P()});window.addEventListener("route-change",()=>{const e=window.location.pathname;document.querySelectorAll(".nav-menu li").forEach(t=>{t.classList.remove("active")}),document.querySelectorAll(".nav-menu a").forEach(t=>{const n=t.getAttribute("href");(n===e||n!=="/"&&e.startsWith(n))&&t.parentElement.classList.add("active")})});let G=[];async function we(){try{const e=await fetch("/api/views");return e.ok?(G=await e.json(),G):(console.warn("Failed to load view definitions, using defaults"),[])}catch(e){return console.error("Error loading views:",e),[]}}const f="",ye="";function $e(e){return["amount","value","balance","total_supply","allowance"].some(n=>e.toLowerCase().includes(n))}let u=null,b=null,y=[],i=null;const O=[{id:"validate",name:"Validate",description:"Check order validity",fields:[]},{id:"reject",name:"Reject",description:"Mark order as invalid",fields:[]},{id:"process_payment",name:"Process Payment",description:"Charge customer payment",fields:[]},{id:"ship",name:"Ship",description:"Send order to shipping",fields:[]},{id:"confirm",name:"Confirm",description:"Mark order as complete",fields:[]}];function xe(){const e=localStorage.getItem("auth");if(e)try{const t=JSON.parse(e);if(t.expires_at&&new Date(t.expires_at)>new Date)return b=t.token,u=t.user,!0;localStorage.removeItem("auth")}catch{localStorage.removeItem("auth")}return!1}function J(e){localStorage.setItem("auth",JSON.stringify(e)),b=e.token,u=e.user,window.dispatchEvent(new CustomEvent("auth-change"))}function R(){localStorage.removeItem("auth"),b=null,u=null,window.dispatchEvent(new CustomEvent("auth-change"))}function ke(){const e=localStorage.getItem("auth");if(e)try{const t=JSON.parse(e);return b=t.token,u=t.user,!0}catch{return!1}return b=null,u=null,!1}window.addEventListener("auth-change",()=>{ke()});function v(){const e={"Content-Type":"application/json"};return b&&(e.Authorization=`Bearer ${b}`),e}async function S(e){if(e.status===401)throw R(),A("Session expired. Please log in again."),new Error("Unauthorized");if(!e.ok){const t=await e.json().catch(()=>({}));throw new Error(t.message||e.statusText)}return e.json()}const g={async getMe(){const e=await fetch(`${f}/auth/me`,{headers:v()});return S(e)},async logout(){await fetch(`${f}/auth/logout`,{method:"POST",headers:v()}),R()},async listInstances(){const e=await fetch(`${f}/admin/instances`,{headers:v()});return S(e)},async getInstance(e){const t=await fetch(`${f}/api/orderprocessing/${e}`,{headers:v()});return S(t)},async createInstance(e={}){const t=await fetch(`${f}/api/orderprocessing`,{method:"POST",headers:v(),body:JSON.stringify(e)});return S(t)},async executeTransition(e,t,n={}){var r,l;const s=n,a=(l=(r=window.pilot)==null?void 0:r.getTransition)==null?void 0:l.call(r,e);let o=(a==null?void 0:a.apiPath)||`/api/${e}`;o=o.replace("{id}",t);const d=await fetch(`${f}${o}`,{method:"POST",headers:v(),body:JSON.stringify({aggregate_id:t,data:s})});return S(d)}};window.api=g;Object.defineProperty(window,"currentInstance",{get:function(){return i}});window.setAuthToken=function(e){b=e};window.saveAuth=J;window.clearAuth=R;function A(e){const t=document.getElementById("app"),n=t.querySelector(".alert-error");n&&n.remove();const s=document.createElement("div");s.className="alert alert-error",s.textContent=e,t.insertBefore(s,t.firstChild),setTimeout(()=>s.remove(),5e3)}function W(e){const t=document.getElementById("app"),n=t.querySelector(".alert-success");n&&n.remove();const s=document.createElement("div");s.className="alert alert-success",s.textContent=e,t.insertBefore(s,t.firstChild),setTimeout(()=>s.remove(),3e3)}function V(e){if(!e)return"unknown";for(const[t,n]of Object.entries(e))if(n>0)return t;return"unknown"}function U(e){return`<span class="badge ${`badge-${e.toLowerCase().replace(/_/g,"-")}`}">${e.replace(/_/g," ")}</span>`}async function D(){const e=document.getElementById("app");e.innerHTML=`
    <div class="page">
  ...
  `;try{y=(await g.listInstances()).instances||[],Ee()}catch{document.getElementById("instances-list").innerHTML=`
    ...
    `}}function Ee(){const e=document.getElementById("instances-list");if(e){if(y.length===0){e.innerHTML=`
      <div class="empty-state">
        <h3>No instances yet</h3>
        <p>Create your first instance to get started.</p>
        <button class="btn btn-primary" onclick="handleCreateNew()" style="margin-top: 1rem">+ Create New</button>
      </div>
    `;return}e.innerHTML=y.map(t=>{const n=V(t.state||t.places);return`
      <div class="entity-card" onclick="navigate('/order-processing/${t.id}')">
        <div class="entity-info">
          <h3>${t.id}</h3>
          <div class="entity-meta">
            ${U(n)} &middot; Version ${t.version||0}
          </div>
        </div>
  ...
  `;try{const s=await g.getInstance(t);i={id:s.aggregate_id||t,version:s.version,state:s.state,displayState:s.state,places:s.places,enabled:s.enabled||s.enabled_transitions||[]},window.currentInstanceState=i.state,L()}catch(s){document.getElementById("instance-detail").innerHTML=`
      <div class="alert alert-error">Failed to load instance: ${s.message}</div>
    `}}function L(){const e=document.getElementById("instance-detail");if(!e||!i)return;const t=V(i.places),n=i.enabled||[],s=O;e.innerHTML=`
    <div class="card">
  ...
  `}function Ae(e){return!e||Object.keys(e).length===0?'<p style="color: #999;">No state data</p>':Object.entries(e).map(([t,n])=>{if(typeof n=="object"&&n!==null){const s=Object.entries(n);return s.length===0?`
        ...
        <div class="detail-field">
          ...
          <dd>
            <div class="nested-state">
              ${s.map(([a,o])=>{if(typeof o=="object"&&o!==null){const d=Object.entries(o);return d.length===0?`
    ...
    `}).join("")}function q(e){return e.replace(/_/g," ").replace(/\b\w/g,t=>t.toUpperCase())}function B(e,t){return $e(e),`<strong>${t}</strong>`}function Te(){if(typeof wallet<"u"&&wallet.getAccount){const e=wallet.getAccount();return(e==null?void 0:e.address)||null}return null}function Ce(e,t){return e?e==="wallet"?Te()||"":e==="user"?(u==null?void 0:u.id)||(u==null?void 0:u.login)||"":(e.startsWith("balances.")||e.includes("."),""):""}function Le(){return`
  ...
  `}let _=null;function Re(e){const t=O.find(s=>s.id===e);if(!t)return;_=e,document.getElementById("action-modal-title").textContent=t.name;const n=t.fields.map(s=>{const o=Ce(s.autoFill,i==null?void 0:i.state)||s.defaultValue||"",d=s.required?"required":"";let r="";if(s.type==="amount")r=`
        <input
          type="number"
          name="${s.name}"
          value="${o}"
      ...
      `;else if(s.type==="address"){const l=je();l.length>0?r=`
          <select name="${s.name}" ${d} class="form-control">
            <option value="">Select address...</option>
            ${l.map(c=>`
              <option value="${c.address}" ${c.address===o?"selected":""}>
                ${c.name||"Account"} (${c.address.slice(0,8)}...${c.address.slice(-6)})
              </option>
            `).join("")}
          </select>
        `:r=`
  ...
  `}async function Ie(){var t,n,s,a,o,d,r;const e=document.getElementById("app");e.innerHTML=`
    <div class="page">
      <div class="page-header">
        <h1>Schema Viewer</h1>
  ...
  `;try{const c=await(await fetch(`${f}/api/schema`)).json(),T=document.getElementById("schema-content");T.innerHTML=`
      <div class="schema-viewer">
        <div class="schema-tabs">
          <button class="schema-tab active" onclick="showSchemaTab('overview')">Overview</button>
          <button class="schema-tab" onclick="showSchemaTab('places')">Places (${((t=c.places)==null?void 0:t.length)||0})</button>
          <button class="schema-tab" onclick="showSchemaTab('transitions')">Transitions (${((n=c.transitions)==null?void 0:n.length)||0})</button>
          <button class="schema-tab" onclick="showSchemaTab('arcs')">Arcs (${((s=c.arcs)==null?void 0:s.length)||0})</button>
        ...
        <div id="schema-tab-overview" class="schema-tab-content active">
          <div class="schema-overview">
            ...
            <div class="schema-stats">
              <div class="stat-item">
                <span class="stat-value">${((a=c.places)==null?void 0:a.length)||0}</span>
                <span class="stat-label">Places</span>
              </div>
              <div class="stat-item">
                <span class="stat-value">${((o=c.transitions)==null?void 0:o.length)||0}</span>
                <span class="stat-label">Transitions</span>
              </div>
              <div class="stat-item">
                <span class="stat-value">${((d=c.arcs)==null?void 0:d.length)||0}</span>
                <span class="stat-label">Arcs</span>
              </div>
              <div class="stat-item">
                <span class="stat-value">${((r=c.roles)==null?void 0:r.length)||0}</span>
        ...
        <div id="schema-tab-raw" class="schema-tab-content" style="display: none;">
          <pre class="schema-json">${JSON.stringify(c,null,2)}</pre>
        </div>
      </div>
  ...
  `;try{const[t,n]=await Promise.all([fetch(`${f}/admin/stats`,{headers:v()}).then(a=>a.json()).catch(()=>null),g.listInstances()]);t?document.getElementById("admin-stats").innerHTML=`
      ...
      `:document.getElementById("admin-stats").innerHTML="",y=n.instances||[];const s=document.getElementById("admin-instances").querySelector(".loading");s&&(s.outerHTML=y.length>0?`<table class="table">
            ...
            <tbody>
              ${y.slice(0,20).map(a=>{const o=V(a.state||a.places);return`
                  <tr>
                    <td><code>${a.id}</code></td>
                    <td>${U(o)}</td>
                    <td>${a.version||0}</td>
                    <td><button class="btn btn-sm btn-link" onclick="navigate('/order-processing/${a.id}')">View</button></td>
                  </tr>
                `}).join("")}
            </tbody>
          </table>`:'<p style="color: #666; padding: 1rem;">No instances yet.</p>')}catch(t){A("Failed to load admin data: "+t.message)}}window.navigate=h;window.handleCreateNew=async function(){h("/order-processing/new")};window.handleSubmitCreate=async function(e){e.preventDefault();try{const t=await g.createInstance({});W("Instance created successfully!"),h(`/order-processing/${t.aggregate_id||t.id}`)}catch(t){A("Failed to create: "+t.message)}};window.handleTransition=async function(e){if(!i)return;const t=O.find(n=>n.id===e);if(t&&t.fields&&t.fields.length>0){Re(e);return}try{const n=await g.executeTransition(e,i.id);i={...i,version:n.version,state:n.state,displayState:n.state,places:n.state,enabled:n.enabled||[]},window.currentInstanceState=i.state,L(),W(`Action "${e}" completed!`)}catch(n){A(`Failed to execute ${e}: ${n.message}`)}};function Y(e){var s;const t=((s=e.detail)==null?void 0:s.route)||C();if(!t){D();return}const n=t.path;n==="/order-processing"||n==="/"?D():n==="/order-processing/new"?Ne():n==="/order-processing/:id"?Se():n==="/schema"?Ie():n==="/admin"||n.startsWith("/admin")?_e():D()}async function Pe(){const e=new URLSearchParams(window.location.search),t=e.get("token"),n=e.get("expires_at");if(t){b=t;try{const s=await g.getMe();J({token:t,expires_at:n,user:s}),window.history.replaceState({},"",window.location.pathname),await P()}catch{R(),A("Failed to complete login")}}}async function Oe(){xe(),await Pe(),await we();const e=document.getElementById("nav");e.innerHTML=await te();const t=document.createElement("div");t.innerHTML=Le(),document.body.appendChild(t),window.addEventListener("route-change",Y),fe(),Y({detail:{route:C()}})}let w=null,j=null;function se(){const t=`${window.location.protocol==="https:"?"wss:":"ws:"}//${window.location.host}/ws`;w=new WebSocket(t),w.onopen=()=>{console.log("[Debug] WebSocket connected")},w.onmessage=n=>{try{const s=JSON.parse(n.data);s.id==="session"&&s.type==="session"?(j=(typeof s.data=="string"?JSON.parse(s.data):s.data).session_id,console.log("[Debug] Session ID:",j)):s.type==="eval"&&Me(s)}catch(s){console.error("[Debug] Failed to parse message:",s)}},w.onclose=()=>{console.log("[Debug] WebSocket disconnected, reconnecting in 3s..."),j=null,setTimeout(se,3e3)},w.onerror=n=>{console.error("[Debug] WebSocket error:",n)}}async function Me(e){try{const n=(typeof e.data=="string"?JSON.parse(e.data):e.data).code,a=await new Function("return (async () => { "+n+" })()")(),o={type:"response",id:e.id,data:{result:a,type:typeof a}};w.send(JSON.stringify(o))}catch(t){const n={type:"response",id:e.id,data:{error:t.message}};w.send(JSON.stringify(n))}}window.debugSessionId=()=>j;window.debugWs=()=>w;window.pilot={async list(){return h("/order-processing"),await this.waitFor(".entity-card, .empty-state",5e3).catch(()=>{}),y},newForm(){return h("/order-processing/new"),this.waitForRender()},async view(e){return h(`/order-processing/${e}`),await this.waitForRender(),i},admin(){return h("/admin"),this.waitForRender()},async create(e={}){const t=await g.createInstance(e),n=t.aggregate_id||t.id;return h(`/order-processing/${n}`),await this.waitForRender(),{id:n,...t}},getCurrentInstance(){return i},getInstances(){return y},async refresh(){if(!i)throw new Error("No current instance");const e=await g.getInstance(i.id);return i={id:e.aggregate_id||i.id,version:e.version,state:e.state,places:e.places,enabled:e.enabled||e.enabled_transitions||[]},L(),i},async action(e,t={}){if(!i)throw new Error("No current instance - navigate to detail page first");const n=await g.executeTransition(e,i.id,t);return i={...i,version:n.version,state:n.state,places:n.state,enabled:n.enabled||[]},L(),{success:!0,state:i.places,enabled:i.enabled}},isEnabled(e){return i?(i.enabled||[]).includes(e):!1},getEnabled(){return(i==null?void 0:i.enabled)||[]},fill(e,t){const n=document.querySelector(`[name="${e}"]`);if(!n)throw new Error(`No input found with name: ${e}`);return n.value=t,n.dispatchEvent(new Event("input",{bubbles:!0})),this},async submit(){const e=document.querySelector("form");if(!e)throw new Error("No form found on page");const t=new Event("submit",{bubbles:!0,cancelable:!0});return e.dispatchEvent(t),await this.waitForRender(),i},getText(e){const t=document.querySelector(e);return t?t.textContent.trim():null},exists(e){return document.querySelector(e)!==null},getButtons(){return Array.from(document.querySelectorAll("button")).map(e=>({text:e.textContent.trim(),disabled:e.disabled,className:e.className}))},async clickButton(e){const t=document.querySelectorAll("button");for(const n of t)if(n.textContent.trim()===e&&!n.disabled)return n.click(),await this.waitForRender(),!0;throw new Error(`No enabled button found with text: ${e}`)},getState(){return(i==null?void 0:i.places)||null},getStatus(){if(!(i!=null&&i.places))return null;for(const[e,t]of Object.entries(i.places))if(t>0)return e;return null},getRoute(){return C()},getUser(){return u},isAuthenticated(){return b!==null},waitForRender(e=50){return new Promise(t=>setTimeout(t,e))},async waitFor(e,t=5e3){const n=Date.now();for(;Date.now()-n<t;){if(document.querySelector(e))return document.querySelector(e);await this.waitForRender(50)}throw new Error(`Timeout waiting for: ${e}`)},async waitForState(e,t=5e3){var s;const n=Date.now();for(;Date.now()-n<t;){if(((s=i==null?void 0:i.places)==null?void 0:s[e])>0)return i;await this.waitForRender(100)}throw new Error(`Timeout waiting for state: ${e}`)},debug(){return console.log("=== Pilot Debug ==="),console.log("Route:",C()),console.log("User:",u),console.log("Instance:",i),console.log("Enabled:",i==null?void 0:i.enabled),console.log("State:",i==null?void 0:i.places),{route:C(),user:u,instance:i}},async getEvents(){if(!i)throw new Error("No current instance");const e=await fetch(`${f}/api/orderprocessing/${i.id}/events`,{headers:v()});return(await S(e)).events||[]},async getEventCount(){return(await this.getEvents()).length},async getLastEvent(){const e=await this.getEvents();return e.length>0?e[e.length-1]:null},async replayTo(e){if(!i)throw new Error("No current instance");const n=(await this.getEvents()).filter(a=>(a.version||a.sequence)<=e),s={};for(const a of n)a.state&&Object.assign(s,a.state);return{version:e,events:n,places:s}},async loginAs(e){const t=typeof e=="string"?[e]:e,s=await(await fetch(`${f}/api/debug/login`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({login:"pilot-user",roles:t})})).json();return J(s),await this.waitForRender(100),s},logout(){return R(),this.waitForRender()},getRoles(){return(u==null?void 0:u.roles)||[]},hasRole(e){return this.getRoles().includes(e)},assertState(e){const t=this.getStatus();if(t!==e)throw new Error(`Expected state '${e}', got '${t}'`);return this},assertEnabled(e){if(!this.isEnabled(e)){const t=this.getEnabled();throw new Error(`Expected '${e}' to be enabled. Enabled: [${t.join(", ")}]`)}return this},assertDisabled(e){if(this.isEnabled(e))throw new Error(`Expected '${e}' to be disabled, but it is enabled`);return this},assertExists(e){if(!this.exists(e))throw new Error(`Expected element '${e}' to exist`);return this},assertText(e,t){const n=this.getText(e);if(n!==t)throw new Error(`Expected '${e}' to contain '${t}', got '${n}'`);return this},assertAuthenticated(){if(!this.isAuthenticated())throw new Error("Expected user to be authenticated");return this},assertRole(e){if(!this.hasRole(e))throw new Error(`Expected user to have role '${e}'. Has: [${this.getRoles().join(", ")}]`);return this},getTransitions(){return[{id:"validate",name:"Validate",description:"Check order validity",requiredRoles:["fulfillment"],apiPath:"/api/validate"},{id:"reject",name:"Reject",description:"Mark order as invalid",requiredRoles:["fulfillment"],apiPath:"/api/reject"},{id:"process_payment",name:"Process Payment",description:"Charge customer payment",requiredRoles:["system"],apiPath:"/api/process_payment"},{id:"ship",name:"Ship",description:"Send order to shipping",requiredRoles:["fulfillment"],apiPath:"/api/ship"},{id:"confirm",name:"Confirm",description:"Mark order as complete",requiredRoles:["fulfillment"],apiPath:"/api/confirm"}]},getPlaces(){return[{id:"received",name:"Received",initial:1},{id:"validated",name:"Validated",initial:0},{id:"rejected",name:"Rejected",initial:0},{id:"paid",name:"Paid",initial:0},{id:"shipped",name:"Shipped",initial:0},{id:"completed",name:"Completed",initial:0}]},getTransition(e){return this.getTransitions().find(t=>t.id===e)||null},canFire(e){const t=this.getTransition(e);if(!t)return{canFire:!1,reason:`Unknown transition: ${e}`};if(!i)return{canFire:!1,reason:"No current instance"};if(!this.isEnabled(e)){const s=this.getStatus();return{canFire:!1,reason:`Transition '${e}' not enabled in state '${s}'`,currentState:s,enabledTransitions:this.getEnabled()}}if(t.requiredRoles&&t.requiredRoles.length>0){const s=this.getRoles();if(!t.requiredRoles.some(o=>s.includes(o)))return{canFire:!1,reason:`User lacks required role. Need one of: [${t.requiredRoles.join(", ")}]. Has: [${s.join(", ")}]`,requiredRoles:t.requiredRoles,userRoles:s}}return{canFire:!0}},async sequence(e,t={}){const n=[],{stopOnError:s=!0,data:a={}}=t;for(const o of e){const d=this.canFire(o);if(!d.canFire){if(s)throw new Error(`Sequence failed at '${o}': ${d.reason}`);n.push({transition:o,success:!1,error:d.reason});continue}try{const r=await this.action(o,a[o]||{});n.push({transition:o,success:!0,state:r.state})}catch(r){if(s)throw r;n.push({transition:o,success:!1,error:r.message})}}return n},getWorkflowInfo(){var e;return{places:this.getPlaces(),transitions:this.getTransitions(),initialPlace:(e=this.getPlaces().find(t=>t.initial>0))==null?void 0:e.id}}};Oe();se();
