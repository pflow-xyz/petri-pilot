      ...
      <div class="dashboard-grid">
        ...
        <div class="concepts-section">
          <div class="concepts-header">
            <h2 class="coffee-heading">🔧 go-pflow Concepts in This Demo</h2>
            <p>Learn how this simulation uses Petri nets for resource management</p>
          </div>

          <pflow-concepts service="coffeeshop"></pflow-concepts>

          <div class="concept-panels">
            <explainer-panel title="Resource Places with Capacity" icon="📦" expanded>
              <p>Each ingredient is modeled as a <strong>place</strong> with a <strong>capacity limit</strong>:</p>
              <ul>
                <li><code>coffee_beans</code> - capacity: 2000g</li>
                <li><code>milk</code> - capacity: 1000ml</li>
                <li><code>cups</code> - capacity: 500 units</li>
                <li><code>water</code> - capacity: 5000ml</li>
              </ul>
              <h5>Why Capacity?</h5>
              <p>Capacity constraints prevent over-accumulation. When a place reaches capacity,
              transitions that would add more tokens are <em>blocked</em>. This models real inventory limits.</p>
            </explainer-panel>

            <explainer-panel title="Weighted Arcs: Resource Consumption" icon="⚖️">
              <p>Arcs in this model have <strong>weights</strong> specifying how many units are consumed or produced:</p>
              <code style="background: rgba(0,0,0,0.1); padding: 0.5rem; border-radius: 4px; display: block; margin: 0.5rem 0;">
coffee_beans →(20)→ make_espresso →(1)→ espresso_ready
              </code>
              <p>This means making an espresso consumes <strong>20 grams</strong> of coffee beans.</p>
              <h5>Recipe Examples</h5>
              <ul>
                <li><strong>Espresso:</strong> 20g beans</li>
                <li><strong>Latte:</strong> 20g beans + 150ml milk</li>
                <li><strong>Cappuccino:</strong> 20g beans + 100ml milk</li>
              </ul>
              <p>Weighted arcs let us model realistic resource consumption ratios.</p>
            </explainer-panel>

            <explainer-panel title="Transition Rates: Continuous Flow" icon="⏱️">
              <p>Each transition has a <strong>rate</strong> defining how often it fires per time unit:</p>
              <ul>
                <li><code>customer_arrival: 0.3</code> - 0.3 customers per second</li>
                <li><code>make_espresso: 0.5</code> - Can make 0.5 drinks per second</li>
                <li><code>customer_served: 0.4</code> - Service rate</li>
              </ul>
              <h5>Rate Balancing</h5>
              <p>If arrival rate exceeds service rate, queues grow. The simulation shows this visually
              through the order flow board and wait time statistics.</p>
            </explainer-panel>

            <explainer-panel title="ODE Prediction: Resource Planning" icon="📈">
              <p>The go-pflow library uses <strong>Ordinary Differential Equations</strong> to predict future states:</p>
              <ol>
                <li>Convert Petri net to continuous equations</li>
                <li>Solve for steady-state flow rates</li>
                <li>Predict when resources will deplete</li>
                <li>Alert before stockouts occur</li>
              </ol>
              <h5>In This Demo</h5>
              <p>The "Stress Alerts" use ODE prediction to warn you when:</p>
              <ul>
                <li>Ingredients are running low</li>
                <li>Queue is growing too fast</li>
                <li>Wait times exceed thresholds</li>
              </ul>
            </explainer-panel>
          </div>

          <div style="margin-top: 1.5rem; text-align: center;">
            <pflow-model-link model="coffeeshop" label="View Coffee Shop Petri Net"></pflow-model-link>
          </div>
        </div>
      </div>
