/**
 * petri-colors.js — colored-net unfolding.
 *
 * A direct port of go-pflow's petri/colors.go, kept byte-identical (modulo this
 * header) with pflow-xyz's public/petri-colors.js, which is where the Go/JS
 * differential (parity/ode, parity/sim) actually locks the contract. Sync from
 ...
 * @param {import('./pflow-engine.js').PetriNet} net
 * @returns {number}
 */
 ...
 *
 * @param {import('./pflow-engine.js').PetriNet} net
 * @returns {{net: import('./pflow-engine.js').PetriNet, colorMap: ColorMap|null}}
 */
export function expandColors(net) {
  ...
  // no import from pflow-engine.js and the two cannot form an import cycle.
